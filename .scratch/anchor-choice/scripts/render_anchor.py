...
J='30917498'; fig=plt.figure(figsize=(14,16))
for r,(arm,a) in enumerate([('anchor0',0),('anchor6',6),('anchor4',4)]):
    npz=Path(f'artifacts/anchor/anchor_{arm}_{J}/clouds/juglet_gt_sample00000.npz')
    ...
    for c,(el,az) in enumerate([(10,0),(10,90),(10,180)]):
        ...
        for s,(p,q) in enumerate(sl):
            ...
            col='tab:blue' if s==a else ('tab:green' if home else 'tab:red')
...
plt.tight_layout(); plt.savefig('artifacts/anchor/anchor_choice_30917498.png',dpi=90); print('ok')
